...
export const BONUS_OPTIONS = [
  ...
  { id: "document-organization", assessmentKey: "includeDocumentOrganizationSetup", name: "Bookkeeping Document Organization", description: "We organize the documents you provide as part of the bookkeeping process." },
